                             ...
                             mbedtls_x509_crl_entry *entry )
{
    ...
    while( *p < end )
    {
        ...
        if( *p < end )
        {
			cur_entry->next = (mbedtls_x509_crl_entry*)mbedtls_calloc(1, sizeof(mbedtls_x509_crl_entry));
                        ...
                        const unsigned char *buf, size_t buflen )
{
    ...
    {
		crl->next = (mbedtls_x509_crl*)mbedtls_calloc(1, sizeof(mbedtls_x509_crl));
     ...
     */
    if( ( p = (unsigned char*)mbedtls_calloc( 1, buflen ) ) == NULL )
        return( MBEDTLS_ERR_X509_ALLOC_FAILED );
